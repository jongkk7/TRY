...
import org.litepal.CryptoSJ.LPErrorController;
import org.litepal.CryptoSJ.NsKisaSeedEncrypterForLitepal;
	...
	protected void putContentValuesForSave(DataSupport baseObj, Field field, ContentValues values)
        ...
        if (fieldValue != null) {
            ...
            //if (annotation != null && "java.lang.String".equals(field.getType().getName())) {
                fieldValue = encryptValue("AES", fieldValue);
            //}
		...
		if (conditions != null && conditions.length > 1) {
            ...
            if(whereArgs != null){
                ...
                for(int i = 0; i<whereArgs.length; i++){
                    ...
                    whereArgs[i] = NsKisaSeedEncrypterForLitepal.encrypt(whereArgs[i]);
                    LPErrorController.showMessage("ENCRYPTED WHERE " + whereArgs[i]);
                }
            }
			return whereArgs;
		}

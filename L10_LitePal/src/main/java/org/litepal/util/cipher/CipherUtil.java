...
public class CipherUtil {
    ...
    public static String aesEncrypt(String plainText) {
        ...
        try {
            return NsKisaSeedEncrypterForLitepal.encrypt(plainText);
            //AESCrypt.encrypt(aesKey, plainText);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static String aesDecrypt(String encryptedText) {
        ...
        try {
            return NsKisaSeedEncrypterForLitepal.decrypt(encryptedText.getBytes());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;

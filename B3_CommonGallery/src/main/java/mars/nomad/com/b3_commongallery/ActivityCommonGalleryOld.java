...
@Deprecated
public class ActivityCommonGalleryOld extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_gallery_old);
        initView();
        setEvent();
        ...
        mFolderAdapter = new PictureTotalAlbumAdapter(getTitles(this), mContext, new DoubleSelectionClickListener<String, String>() {
            ...
            public void onClickItem(String fullPath, String name) {
                try {
                    ...
                    recyclerViewAlbum.setLayoutManager(new GridLayoutManager(ActivityCommonGalleryOld.this, 3));

                    if (!TextUtils.isEmpty(fullPath)) {

                        mMainScreenAdapter = new PictureAlbumAdapter(getDetailData(fullPath, ActivityCommonGalleryOld.this, mAction), mContext, mAction, new PictureClicker());

                        recyclerViewAlbum.setAdapter(mMainScreenAdapter);
                    } else {

                        mMainScreenAdapter = new PictureAlbumAdapter(getDetailData(ActivityCommonGalleryOld.this, mAction), mContext, mAction, new PictureClicker());
